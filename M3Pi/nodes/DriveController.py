class TankDrive():
    ...
    def __init__(self):
        ...
        self.max_x_velocity = 1.0    #Maximum X (linear) velocity in M/S
        self.max_z_rotational = 1.0    #Maximum Z (rotation) in radians/S
        self.max_vehicle_velocity = 1.0 #Maximum vehicle velocity in M/S (probably the same as the maximum X velocity)
